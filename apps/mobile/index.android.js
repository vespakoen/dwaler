...
setTimeout(() => {
  fetch('http://localhost:9997/berlino/0/0/0.pbf').then(res => res.text()).then(res => console.log(res))
}, 2000)
  ...
  _renderButtons() {
    return (
      <View>
        ...
        <Text onPress={() => this._map && this._map.setCenterCoordinateZoomLevel(52.5156579,13.3548103, 14)}>
          Go to Berlin at fixed zoom level 14
        </Text>
